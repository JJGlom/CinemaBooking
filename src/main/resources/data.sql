...
INSERT INTO movies (title, description, genre, director, duration_minutes, age_restriction, poster_url, trailer_url, cast_members)
SELECT 'Diuna: Część druga', 'Książę Paul Atryda przyjmuje przydomek Muad''Dib i rozpoczyna duchowo-fizyczną podróż.', 'Sci-Fi', 'Denis Villeneuve', 166, 13, 'https://image.tmdb.org/t/p/original/8b8R8l88Qje9dn9OE8PY05Nxl1X.jpg', 'https://www.youtube.com/embed/Way9Dexny3w', 'Timothée Chalamet, Zendaya'
WHERE NOT EXISTS (SELECT 1 FROM movies WHERE title = 'Diuna: Część druga');

INSERT INTO movies (title, description, genre, director, duration_minutes, age_restriction, poster_url, trailer_url, cast_members)
SELECT 'Oppenheimer', 'Historia amerykańskiego naukowca J. Roberta Oppenheimera i jego roli w stworzeniu bomby atomowej.', 'Biograficzny', 'Christopher Nolan', 180, 16, 'https://image.tmdb.org/t/p/original/8Gxv8gSFCU0XGDykEGv7zR1n2ua.jpg', 'https://www.youtube.com/embed/uYPbbksJxIg', 'Cillian Murphy, Emily Blunt'
